...
<div className={styles.DivTable}>
    <table className={styles.line}>
        ...
        <tr>
            ...
            <td className={styles.status}>направлена</td>
            <td>Вакансия 2021 Q2</td>
            <td>Ведущий разработчик</td>
            <td>Ведущий разработчик</td>
            <td>Князев Николай Сергеевич</td>
            <td className={styles.status}>потребность</td>
            <td>1,0</td>
        ...
        <tr>
            ...
            <td className={styles.status}>в работе</td>
        ...
        <tr>
            <td><img className={styles.punkt} src={punkt}></img></td>
            <td className={styles.status}>закрыта</td>
            <td>Вакансия 2021 Q2 <img className={styles.strelka} src={strelka}></img></td>
            <td>Разработчик</td>
            <td>Разработчик</td>
